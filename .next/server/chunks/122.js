...
var portfolio_module = __webpack_require__(1001);
...
;// CONCATENATED MODULE: ./src/store/bridal_page1.js
const Bridal_url = {
    link: [
...
;// CONCATENATED MODULE: ./src/components/Portfolio.jsx
...
function Portfolio({ query  }) {
    ...
    const { 0: portfolioOption , 1: setPortfolioOption  } = (0,external_react_.useState)('ALL');
    const { 0: menu , 1: openMenu  } = (0,external_react_.useState)(false);
    ...
    return(/*#__PURE__*/ (0,jsx_runtime_.jsxs)("main", {
        className: (portfolio_module_default()).main,
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx(Navbar/* TopNav */.t, {
                openMenu: onGettingOpenMenuHandler
            }),
            menu && /*#__PURE__*/ jsx_runtime_.jsx(Modal/* MenuModal */.H, {
            }),
            query == 'indoor' && /*#__PURE__*/ jsx_runtime_.jsx("div", {
                className: (portfolio_module_default()).portfolio_heading,
                children: /*#__PURE__*/ jsx_runtime_.jsx("h2", {
                    children: "indoor"
                }, "Indoor")
            }),
            query == 'commercial' && /*#__PURE__*/ jsx_runtime_.jsx("div", {
                className: (portfolio_module_default()).portfolio_heading,
                children: /*#__PURE__*/ jsx_runtime_.jsx("h2", {
                    children: "commercial"
                }, "Commercial")
            }),
            query == 'product' && /*#__PURE__*/ jsx_runtime_.jsx("div", {
                className: (portfolio_module_default()).portfolio_heading,
                children: /*#__PURE__*/ jsx_runtime_.jsx("h2", {
                    children: "product"
                }, "Product")
            }),
            query == 'wedding' && /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                className: (portfolio_module_default()).portfolio_heading,
                children: [
                    ...
                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                        className: (portfolio_module_default()).wedding_options,
                        children: [
            ...
            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                className: (portfolio_module_default()).portfolio_content1,
                children: wedding_url.link.map((u)=>{
                    return(/*#__PURE__*/ jsx_runtime_.jsx("img", {
                        src: u,
                        className: (portfolio_module_default()).portfolio_image,
                        onClick: imageZoomHandler
                    }));
                })
            }),
            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                className: (portfolio_module_default()).portfolio_content2,
            ...
            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                className: (portfolio_module_default()).portfolio_content3,
                children: wedding_url.link.map((u)=>{
                    return(/*#__PURE__*/ jsx_runtime_.jsx("img", {
                        src: u,
                        className: (portfolio_module_default()).portfolio_image,
            ...
            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                className: (portfolio_module_default()).portfolio_content4,
                children: nature_url.link.map((u)=>{
                    return(/*#__PURE__*/ jsx_runtime_.jsx("img", {
                        src: u,
                        className: (portfolio_module_default()).portfolio_image,
