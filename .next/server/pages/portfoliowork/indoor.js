...
function indoor({ data  }) {
    return(/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_src_components_IndoorPortfolio__WEBPACK_IMPORTED_MODULE_3__/* .IndoorPortfolio */ .OL, {
        dataa: data
    }));
}
async function getStaticProps() {
    const data = _src_store_bridal_page1__WEBPACK_IMPORTED_MODULE_2__/* .wedding_url.link */ .i2.link;
    return {
        props: {
            data
        }
...
var __webpack_exports__ = __webpack_require__.X(0, [730,664,261,98], () => (__webpack_exec__(734)));
